...
inquirer
  ...
  .then(answer => {
    ...
    if (appPackage.devDependencies) {
      // We used to put react-_scripts in devDependencies
    ...
    console.log(cyan('Updating the _scripts'));
    ...
    if (ownPath.indexOf(appPath) === 0) {
      try {
        // remove react-_scripts and react-_scripts binaries from app node_modules
        Object.keys(ownPackage.bin).forEach(binKey => {
