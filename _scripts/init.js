...
module.exports = function(
  ...
  appPackage.scripts = {
    start: 'react-_scripts-ts start',
    build: 'react-_scripts-ts build',
    test: 'react-_scripts-ts test --env=jsdom',
    eject: 'react-_scripts-ts eject',
  };
  ...
  // which doesn't install react and react-dom along with react-_scripts
  ...
  console.log(
    '    and _scripts into the app directory. If you do this, you can’t go back!'
  );
  console.log();
